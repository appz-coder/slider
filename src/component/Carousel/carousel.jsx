                                        ...
                                        <div key={i}>
                                            {
                                                pres.mime.endsWith('pdf') ? (
                                                    ...
                                                    <div className={index === i ? "m-4 active_scroll" : "m-4"} key={i}
                                                         onClick={(e) => { indexSelect(i) }}>
                                                        <img width={"100%"} height={"250px"} alt={`Presentation ${i + 1}`} // Add an appropriate alt text
                                                             src={`${process.env.REACT_APP_API_URL}${pres.path}`}
                                                        />
                                                    </div>)
                                            }
                                        </div>
